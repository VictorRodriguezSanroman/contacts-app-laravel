                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="m-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            </svg> <a class="text-info" href="tel:+34{{ $contact->phone_number }}">{{ $contact->phone_number }}</a></p>
                        <p class="m-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            </svg> <a class="text-info"  href="mailto:{{ $contact->email }}">{{ $contact->email }}</a>
                        </p>
                        <p class="m-2">Created at: {{ $contact->created_at }}</p>
                        <p class="m-2">Last updated: {{ $contact->updated_at }}</p>
