...
@section('content')
    <div class="container">
        <x-alert />
        <h1 class="text-center">Contacts shares with me</h1>
        @forelse ($contactSharedWithUser as $contact)
            <div class="d-flex justify-content-between bg-dark mb-3 rounded px-4 py-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <p class="me-2 mb-0 d-none d-md-block">
                        <a class="text-white" href="tel:{{ $contact->phone_number }}">
        ...
        <h1 class="text-center">Contacts shares by me</h1>
        @forelse ($contactSharedByUser as $contact)
        ...
        @empty
            <div class="col-md-4 mx-auto">
                <div class="card card-body text-center">
                    ...
                    <p>
                        <a href="{{ route('contact-shares.create') }}">Share contacts here</a>
                    </p>
                </div>
            </div>
        @endforelse
